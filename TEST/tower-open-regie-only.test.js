...
assert.match(tower, /performance\.amountToInvoice>\.005\|\|!performance\.complete/);
...
assert.match(tower, /Aus Liste nehmen/);
assert.match(tower, /Wieder aufnehmen/);
assert.match(tower, /towerBillingHidden/);
assert.match(server, /towerBillingHidden: !!\(patch\.towerBillingHidden \?\? existing\.towerBillingHidden\)/);
assert.match(server, /towerBillingHidden: req\.body\?\.towerBillingHidden/);
