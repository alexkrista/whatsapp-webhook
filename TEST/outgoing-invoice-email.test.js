...
for(const text of ["/send-email","PDF öffnen","/source-pdf","Per E-Mail senden","Mit farbenfrohen Grüßen aus Frastanz","MMSt. Ing. Alexander Krista","krista_invoice_logo.png","rechnungsversand.jsonl"])assert.ok(source.includes(text),text);
