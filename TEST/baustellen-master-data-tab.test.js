...
assert.match(hub,/E-Mail Bauherrin/);
assert.match(hub,/E-Mail Bauherr/);
assert.match(hub,/bkOwnerWomanEmail/);
assert.match(hub,/bkOwnerManEmail/);
assert.match(hub,/Bauleitung/);
assert.match(hub,/Architekt/);
assert.match(hub,/Nachname Bauherrin/);
assert.match(hub,/Nachname Bauherr/);
assert.match(hub,/Anrede Bauherrin/);
...
assert.match(hub,/VORARLBERG_POSTAL_PLACES/);
assert.match(hub,/6833\|Klaus\|Weiler\|Fraxern/);
assert.match(hub,/installVorarlbergAddressAssist\("bkSitePostal","bkSiteCity"\)/);
assert.match(hub,/installVorarlbergAddressAssist\("bkHomePostal","bkHomeCity"\)/);
assert.match(hub,/PLZ und Ort ergänzen sich automatisch/);
assert.match(hub,/In KRISTINE suchen/);
assert.match(hub,/In WinWorker suchen/);
assert.match(hub,/Neue Kontakte werden beim Speichern automatisch in KRISTINE aufgenommen/);
assert.match(hub,/bkSiteManagerStreet/);
assert.match(hub,/bkArchitectStreet/);
assert.match(hub,/\/admin\/api\/contact-master/);
assert.match(hub,/project\/address-search/);
...
assert.match(server,/womanEmail/);
assert.match(server,/manEmail/);
assert.match(server,/contactMasterStore\.captureJob/);
assert.match(server,/\/admin\/api\/contact-master/);
