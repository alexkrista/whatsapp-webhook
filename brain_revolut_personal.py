...
def install(ns):
    ...
    def brain_revolut_personal_page():
        return render_template_string('''<!doctype html><html lang="de"><meta charset="utf-8"><title>Revolut · KRISTINE</title>
...
<a href="/">← KRISTINE</a><h1>Revolut</h1><p>Kontostand und gebuchte Bewegungen · automatische Aktualisierung höchstens einmal täglich</p><section><p id="state">Abruf läuft …</p><h2 id="balance"></h2><small id="at"></small><ul id="rows"></ul><a href="https://protokoll.krista.at/banking/enablebanking">Bankfreigabe verwalten</a></section>
