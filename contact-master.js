...
function cleanRoleData(value, role) {
  ...
  return {
    ...
    sharedLastName: cleanText(row.sharedLastName, 120),
    womanTitle: cleanText(row.womanTitle, 40),
    womanFirstName: cleanText(row.womanFirstName || row.firstName, 100),
    womanLastName: cleanText(row.womanLastName || row.sharedLastName, 120),
    ...
    manLastName: cleanText(row.manLastName || row.sharedLastName, 120),
