...
(function(){
  ...
  function injectStyle(){
    ...
    const s=document.createElement("style");s.id="kristaTimeModelsV2Style";s.textContent=`
      #scheduleModelList{display:grid;gap:16px}
      .tm2-card{background:#fff;border:1px solid #dedbd4;border-left:5px solid #27713d;border-radius:16px;padding:16px;box-shadow:0 2px 12px rgba(0,0,0,.04)}
      ...
      .tm2-block{border:1px solid #e7e3dc;border-radius:14px;overflow:hidden;margin-top:11px}.tm2-block-head{display:flex;justify-content:space-between;gap:12px;align-items:center;background:#f7f5f0;padding:11px 13px}.tm2-block-head strong{font-size:15px}.tm2-block-head small{display:block;color:#707070;margin-top:2px}.tm2-fixed-toggle{display:flex!important;align-items:center;gap:7px;margin:0!important;font-weight:800;color:#333}.tm2-fixed-toggle input{width:auto!important}
      .tm2-rows{padding:5px 12px 10px}.tm2-row{display:grid;grid-template-columns:minmax(260px,1.5fr) repeat(6,minmax(92px,.75fr)) minmax(88px,.55fr) auto;gap:8px;align-items:end;padding:10px 0;border-top:1px solid #eee}.tm2-row:first-child{border-top:0}.tm2-row.has-activity{grid-template-columns:minmax(260px,1.4fr) repeat(6,minmax(88px,.66fr)) minmax(155px,1fr) minmax(82px,.5fr) auto}
      .tm2-days{display:flex;gap:5px;flex-wrap:wrap;align-items:center;align-self:center;padding-bottom:2px}.tm2-day{width:34px!important;min-width:34px!important;height:34px;padding:0!important;border-radius:50%!important;background:#fff!important;color:#444!important;border:1px solid #cfd3cf!important;font-weight:800}.tm2-day.on{background:#27713d!important;color:#fff!important;border-color:#27713d!important}.tm2-field label{font-size:10px;text-transform:uppercase;letter-spacing:.04em;color:#777}.tm2-field input,.tm2-field select{padding:8px!important;min-width:0!important;width:100%!important}.tm2-net{background:#eef7ee;border-radius:9px;padding:8px 9px;text-align:center;font-weight:900;white-space:nowrap}.tm2-remove{width:34px!important;min-width:34px!important;height:34px;padding:0!important;background:#fff!important;color:#9d2525!important;border:1px solid #e0bcbc!important}.tm2-empty{padding:13px;color:#777;font-size:13px}.tm2-add{margin:0 12px 12px;padding:7px 10px!important;background:#fff!important;color:#202020!important;border:1px solid #ccc!important}.tm2-savebar{display:flex;justify-content:flex-end;gap:9px;margin-top:14px}.tm2-savebar .green{font-weight:800}.tm2-note{margin-right:auto;color:#27713d;font-weight:800;font-size:12px;align-self:center}
      @media(max-width:1150px){.tm2-row,.tm2-row.has-activity{grid-template-columns:repeat(4,minmax(130px,1fr))}.tm2-days{grid-column:1/-1}.tm2-net{align-self:end}.tm2-remove{align-self:end}.tm2-row.has-activity .tm2-activity{grid-column:1/3}}
      @media(max-width:700px){.tm2-row,.tm2-row.has-activity{grid-template-columns:1fr 1fr}.tm2-days{grid-column:1/-1}.tm2-row.has-activity .tm2-activity{grid-column:1/-1}.tm2-head{align-items:flex-start;flex-direction:column}}
