...
(function () {
  ...
  function loadKristineTaskList() {
    if (isKristineMainPath()) loadScriptOnce("/public/ui/kristine-task-list.js?v=20260918-customer-points-2", "data-krista-task-list");
  }
  ...
  function loadBaustellenKnowledgeStack() {
    ...
    loadScriptOnce("/public/ui/baustellen-knowledge-hub.js?v=20260915-progress-2&b=20260918-vorarlberg-address-contact-2-order-confirmation-20260919-1", "data-krista-baustellen-knowledge");
    ...
    loadScriptOnce("/public/ui/baustellen-offer-builder.js?v=20260918-approved-pdf-only-3-order-schedule-regie-hours-7-order-confirmation-20260919-1", "data-krista-angebot-v13");
  }
