...
(function () {
  ...
  function loadBaustellenKnowledgeStack() {
    ...
    loadScriptOnce("/public/ui/baustellen-offer-builder.js?v=20260918-approved-pdf-only-3-order-schedule-regie-hours-7-order-confirmation-20260919-1-scheduling-notices-2-invoice-5-company-mail", "data-krista-angebot-v13");
  }
  ...
  function loadKrisadminHome() {
    ...
    if (path.includes("/admin") && !path.includes("/admin/paint") && !path.includes("/admin/akte") && !path.includes("/admin/pdf") && !path.includes("/admin/download")) {
      loadScriptOnce("/public/ui/krisadmin-home.js?v=20260919-formularvorlagen-1", "data-krista-krisadmin-home");
    }
  }
