...
(function () {
  ...
  function loadBaustellenKnowledgeStack() {
    ...
    loadScriptOnce("/public/ui/regie-billing-state.js?v=20260913-hours-balance-2", "data-krista-regie-billing-state");
    loadScriptOnce("/public/ui/baustellen-knowledge-hub.js?v=20260913-hours-balance-2", "data-krista-baustellen-knowledge");
    loadScriptOnce("/public/ui/baustellen-cockpit.js?v=20260913-hours-balance-2", "data-krista-baustellen-cockpit");
    ...
    loadScriptOnce("/public/ui/baustellen-live-hours.js?v=20260913-hours-balance-2", "data-krista-baustellen-live-hours");
    ...
    loadScriptOnce("/public/ui/baustellen-calculation-v2.js?v=20260913-hours-balance-2", "data-krista-kalkulation-v1");
    loadScriptOnce("/public/ui/baustellen-calculation-parser-fix.js?v=20260826-flatpos1", "data-krista-kalkulation-parser-fix");
    loadScriptOnce("/public/ui/baustellen-calculation-grid-v2.js?v=20260913-hours-balance-2", "data-krista-kalkulation-grid-v2");
