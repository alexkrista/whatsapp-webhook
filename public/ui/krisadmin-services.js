...
(() => {
  ...
  if (location.pathname.toLowerCase().includes("baustellen.html")) {
    load("/public/ui/baustellen-calculation-v2.js?v=20260909-ww-offer-nachtrag-2", "data-krista-kalkulation-v1");
  ...
  if (location.pathname.toLowerCase().includes("access-admin.html")) {
    ...
    load("/public/ui/access-events-ui.js?v=20260827-zutritte2", "data-krista-access-events");
  }
})();
