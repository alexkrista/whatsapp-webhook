...
(function(){
  ...
  function taskAssigneeChoices(){
    ...
    let preferred=options.find(o=>String(o.dataset.name||o.textContent||"").trim().toLowerCase()==="alexander krista");
    if(!preferred)preferred=options.find(o=>/^alex(?:ander)?\b/i.test(String(o.dataset.name||o.textContent||"").trim()));
