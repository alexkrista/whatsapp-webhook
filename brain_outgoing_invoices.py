...
function linkedInvoiceAction(){const value=String(new URLSearchParams(location.search).get('action')||'').toUpperCase();return ['TR','RE','GS'].includes(value)?value:''}
