...
function enhanceRegieEditor(){decorateRegieEditor();addEditorInsertButtons();addReportDiscountControls();mountPricingFactbox();mountOrderPositionPicker();mountInvoiceLiveTotals();wireEditorCatalogs()}
