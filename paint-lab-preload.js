  ...
  app.get("/admin/paint", (req, res, next) => {
    ...
    fs.readFile(file, "utf8", (error, html) => {
      ...
      if (!fixed.includes("/public/paint-inventory-ui.js")) {
        fixed = fixed.replace("</body>", '<script src="/public/paint-inventory-ui.js?v=20260918-pricelists-2"></script>\n</body>');
      }
      ...
      if (!fixed.includes("/public/paint-mix-history-ui.js")) {
        fixed = fixed.replace("</body>", '<script src="/public/paint-mix-history-ui.js?v=20260916-taskrepair"></script>\n</body>');
      }
