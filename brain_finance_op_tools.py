...
(function(){
  ...
  function filteredDebits(){const horizon=Number(document.getElementById('directDebitRange')?.value||7);return (data.directDebit||[]).filter(x=>{const d=daysTo(x.expectedDebitDate||x.dueDate);return d==null||d<=horizon})}
